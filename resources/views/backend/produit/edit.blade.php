...
{{--               F.Edite     appel de la variable en préremplissage : value='{{#}}'--}}
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" class="form-control" id="prix_ht" name="prix_ht" value="{{$produit->prix_ht}}">
                </div>
                <div class="form-group col-md-2">
...
{{--                    Affichage de la mignature de l'image--}}
                    <img width="100" class="img-thumbnail rounded-circle" style="border:3px solid #5b64f1"
