...
{{--                value="{{old('nom')}}" = garde afficher les valeurs deja tapper lors dun update de la page en cas d'erreur--}}
                <input type="text" class="form-control" id="nom" name="nom" value="{{old('nom')}}">
            </div>
            <div class="form-group col-md-3">
                <label for="prix_ht">PRIX H.T</label>
                <input type="number" class="form-control" id="prix_ht" name="prix_ht" value="{{old('prix_ht')}}">
            </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select multiple class="form-control" name="produits_recommandes[]" id="produits_recommandes">
                    ...
                    <option value="{{$recommandation->id}}">{{$recommandation->nom}}</option>
                    @endforeach
                </select>
            </div>
